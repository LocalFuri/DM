...
public class DungeonFeatureEditor : EditorWindow
{
  ...
  // Additional original Hook appearances generated by Dungeon Master's
  // deterministic random-wall-ornament logic. The explicit fallback Hook
  // at (13,8) South remains in OriginalHallWallOrnaments above.
  private static readonly OriginalWallOrnamentMarker[]
      OriginalHallRandomHooks =
  {
    new OriginalWallOrnamentMarker(
        "Hook", 12, 6, WallSide.West, true),
    new OriginalWallOrnamentMarker(
        "Hook", 17, 11, WallSide.West, true),
    new OriginalWallOrnamentMarker(
        "Hook", 5, 15, WallSide.West, true),
    new OriginalWallOrnamentMarker(
